...
app.title('Disaster Relief Aid Distribution Management System')
app.geometry('1300x420')
app.config(bg='#ffc0cb')
app.resizable(FALSE, FALSE)

font1 = ('Monolisa', 20, 'bold')
font2 = ('Monolisa', 12, 'bold')
...
beneficiary_id_label = customtkinter.CTkLabel(app, font=font1, text='Beneficiary ID:', text_color='#000000', bg_color='#faebd7')
beneficiary_id_label.place(x=20, y=30)

beneficiary_id_entry = customtkinter.CTkEntry(app, font=font1, text_color='#000', fg_color='#a9a9a9', border_width=2, width=180)
beneficiary_id_entry.place(x=180, y=30)

item_label = customtkinter.CTkLabel(app, font=font1, text='Item:', text_color='#000000', bg_color='#faebd7')
item_label.place(x=20, y=80)

item_entry = customtkinter.CTkEntry(app, font=font1, text_color='#000', fg_color='#a9a9a9', border_width=2, width=180)
item_entry.place(x=180, y=80)

location_label = customtkinter.CTkLabel(app, font=font1, text='Location:', text_color='#000000', bg_color='#faebd7')
location_label.place(x=20, y=130)

location_entry = customtkinter.CTkEntry(app, font=font1, text_color='#000', fg_color='#a9a9a9', border_width=2, width=180)
location_entry.place(x=180, y=130)

beneficiary_label = customtkinter.CTkLabel(app, font=font1, text='Beneficiary:', text_color='#000000', bg_color='#faebd7')
beneficiary_label.place(x=20, y=180)

beneficiary_entry = customtkinter.CTkEntry(app, font=font1, text_color='#000', fg_color='#a9a9a9', border_width=2, width=180)
beneficiary_entry.place(x=180, y=180)

quantity_label = customtkinter.CTkLabel(app, font=font1, text='Quantity:', text_color='#000000', bg_color='#faebd7')
quantity_label.place(x=20, y=230)

quantity_entry = customtkinter.CTkEntry(app, font=font1, text_color='#000', fg_color='#a9a9a9', border_width=2, width=180)
quantity_entry.place(x=180, y=230)

add_button = customtkinter.CTkButton(app, command=insert, font=font1, text_color='#000000', text='Add Record', fg_color='#ffa07a', hover_color='#00850B', bg_color='#faebd7', cursor='hand2', corner_radius=15, width=260)
add_button.place(x=20, y=310)

clear_button = customtkinter.CTkButton(app, command=lambda: clear(True), font=font1, text_color='#000000', text='Clear', fg_color='#ffa07a', hover_color='#00850B', bg_color='#faebd7', cursor='hand2', corner_radius=15, width=260)
clear_button.place(x=20, y=360)

update_button = customtkinter.CTkButton(app, command=update, font=font1, text_color='#000000', text='Update Record', fg_color='#ffa07a', hover_color='#00850B', bg_color='#faebd7', cursor='hand2', corner_radius=15, width=260)
update_button.place(x=300, y=360)
delete_button = customtkinter.CTkButton(app, command=delete, font=font1, text_color='#000000', text='Delete Record', fg_color='#ffa07a', hover_color='#00850B', bg_color='#faebd7', cursor='hand2', corner_radius=15, width=260)
delete_button.place(x=580, y=360)
style = ttk.Style(app)
style.theme_use('clam')
style.configure('Treeview', font=font2, foreground='#ffffff', background='#000', fieldbackground='#d3d3d3')
